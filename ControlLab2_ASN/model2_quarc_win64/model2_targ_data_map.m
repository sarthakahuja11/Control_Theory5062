  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% model2_P.HILReadEncoderTimebase_clock
	  ...
	  ;% model2_P.HILReadEncoderTimebase_channels
	  ...
	  ;% model2_P.HILInitialize_OOInitial
	  ...
	  ;% model2_P.Internal_InitialCondition
	  ...
	  ;% model2_P.HILReadEncoderTimebase_Active
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% model2_DW.HILInitialize_FilterFrequency
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	  ...
	  ;% model2_DW.TransportDelay_RWORK.modelTStart
	  ...
	  ;% model2_DW.TransportDelay_PWORK.TUbufferPtrs
	  section.data(1).logicalSrcIdx = 4;
	  section.data(1).dtTransOffset = 0;
	
	  ;% model2_DW.HILWriteAnalog_PWORK
	  section.data(2).logicalSrcIdx = 5;
	  section.data(2).dtTransOffset = 2;
	
	  ;% model2_DW.Scope1_PWORK.LoggedData
	  ...
	  ;% model2_DW.HILInitialize_ClockModes
	  section.data(1).logicalSrcIdx = 7;
	  section.data(1).dtTransOffset = 0;
	
	  ;% model2_DW.HILInitialize_DOStates
	  section.data(2).logicalSrcIdx = 8;
	  section.data(2).dtTransOffset = 1;
	
	  ;% model2_DW.HILInitialize_QuadratureModes
	  section.data(3).logicalSrcIdx = 9;
	  section.data(3).dtTransOffset = 2;
	
	  ;% model2_DW.HILInitialize_InitialEICounts
  ...
  targMap.checksum0 = 3623946941;
  targMap.checksum1 = 91152585;
  targMap.checksum2 = 66687376;
  targMap.checksum3 = 733280347;
