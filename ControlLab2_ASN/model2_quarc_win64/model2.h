...
#define model2_rtModel                 RT_MODEL_model2_T
...
#define rtB                            model2_B
#define BlockIO                        B_model2_T
#define rtX                            model2_X
#define ContinuousStates               X_model2_T
#define rtXdot                         model2_XDot
#define StateDerivatives               XDot_model2_T
#define tXdis                          model2_XDis
#define StateDisabled                  XDis_model2_T
#define rtP                            model2_P
#define Parameters                     P_model2_T
#define rtDWork                        model2_DW
#define D_Work                         DW_model2_T
 ...
 * External functions *
 *====================*/
extern model2_rtModel *model2(void);
 ...
 *
 * '<Root>' : 'model2'
 * '<S1>'   : 'model2/LTI System1'
 * '<S2>'   : 'model2/LTI System1/IO Delay'
 * '<S3>'   : 'model2/LTI System1/Input Delay'
 * '<S4>'   : 'model2/LTI System1/Output Delay'
 */
