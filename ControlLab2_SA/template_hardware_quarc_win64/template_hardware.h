 ...
 * C source code generated on : Fri Nov 19 11:22:57 2021
 *
...
#ifndef RTW_HEADER_template_hardware_h_
#define RTW_HEADER_template_hardware_h_
#include <string.h>
#ifndef template_hardware_COMMON_INCLUDES_
# define template_hardware_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* template_hardware_COMMON_INCLUDES_ */

#include "template_hardware_types.h"
...
#define template_hardware_rtModel      RT_MODEL_template_hardware_T

/* Block signals (default storage) */
typedef struct {
  real_T y_m;                          /* '<Root>/HIL Read Encoder Timebase' */
  real_T y_mrad;                       /* '<Root>/counts to rad' */
} B_template_hardware_T;
...
} DW_template_hardware_T;

/* Backward compatible GRT Identifiers */
#define rtB                            template_hardware_B
#define BlockIO                        B_template_hardware_T
#define rtP                            template_hardware_P
#define Parameters                     P_template_hardware_T
#define rtDWork                        template_hardware_DW
#define D_Work                         DW_template_hardware_T

/* Parameters (default storage) */
struct P_template_hardware_T_ {
...
struct tag_RTM_template_hardware_T {
  const char_T *path;
...
extern P_template_hardware_T template_hardware_P;

/* Block signals (default storage) */
extern B_template_hardware_T template_hardware_B;

/* Block states (default storage) */
extern DW_template_hardware_T template_hardware_DW;

/* Model entry point functions */
extern void template_hardware_initialize(void);
extern void template_hardware_output(void);
extern void template_hardware_update(void);
extern void template_hardware_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern template_hardware_rtModel *template_hardware(void);
...
extern RT_MODEL_template_hardware_T *const template_hardware_M;
 ...
 *
 * '<Root>' : 'template_hardware'
 */
#endif                                 /* RTW_HEADER_template_hardware_h_ */
