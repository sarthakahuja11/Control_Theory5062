...
#ifndef RTW_HEADER_model_5_h_
#define RTW_HEADER_model_5_h_
#include <math.h>
#include <string.h>
#ifndef model_5_COMMON_INCLUDES_
# define model_5_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* model_5_COMMON_INCLUDES_ */

#include "model_5_types.h"
...
#define model_5_rtModel                RT_MODEL_model_5_T
...
typedef struct {
  ...
  real_T u;                            /* '<Root>/Gain' */
  real_T y_mrad;                       /* '<Root>/counts to rad' */
...
typedef struct {
  real_T Internal_CSTATE[2];           /* '<S1>/Internal' */
} X_model_5_T;
...
/* State disabled  */
typedef struct {
  boolean_T Internal_CSTATE[2];        /* '<S1>/Internal' */
} XDis_model_5_T;
...
#define rtB                            model_5_B
#define BlockIO                        B_model_5_T
#define rtX                            model_5_X
#define ContinuousStates               X_model_5_T
#define rtXdot                         model_5_XDot
#define StateDerivatives               XDot_model_5_T
#define tXdis                          model_5_XDis
#define StateDisabled                  XDis_model_5_T
#define rtP                            model_5_P
#define Parameters                     P_model_5_T
#define rtDWork                        model_5_DW
#define D_Work                         DW_model_5_T
...
struct P_model_5_T_ {
  ...
  real_T countstorad_Gain;             /* Expression: 2*pi/512/4
                                        ...
                                        */
  real_T Internal_A[2];                /* Computed Parameter: Internal_A
...
extern P_model_5_T model_5_P;

/* Block signals (default storage) */
extern B_model_5_T model_5_B;

/* Continuous states (default storage) */
extern X_model_5_T model_5_X;

/* Block states (default storage) */
extern DW_model_5_T model_5_DW;

/* Model entry point functions */
extern void model_5_initialize(void);
extern void model_5_output(void);
extern void model_5_update(void);
extern void model_5_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern model_5_rtModel *model_5(void);
...
extern RT_MODEL_model_5_T *const model_5_M;
 ...
 *
 * '<Root>' : 'model_5'
 * '<S1>'   : 'model_5/LTI System'
 * '<S2>'   : 'model_5/LTI System/IO Delay'
 * '<S3>'   : 'model_5/LTI System/Input Delay'
 * '<S4>'   : 'model_5/LTI System/Output Delay'
 */
#endif                                 /* RTW_HEADER_model_5_h_ */
